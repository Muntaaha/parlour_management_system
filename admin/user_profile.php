<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $user_branch = $row_user['admin_branch'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="<?php echo $user_branch; ?>"  name="admin_branch" type="text" class="form-control" required>
...
if(isset($_POST['update'])){
    ...
    $user_branch = $_POST['admin_branch'];
    ...
    $update_user = "update admin set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_address='$user_address',admin_contact='$user_contact',admin_branch='$user_branch',
	admin_image='$user_image' where admin_id='$user_id'";
