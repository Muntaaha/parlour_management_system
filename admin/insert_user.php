               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="admin_branch" type="text" class="form-control" required>
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admin (admin_name,admin_email,admin_pass,admin_address,admin_contact,admin_branch,admin_image) values ('$user_name','$user_email','$user_pass','$user_address','$user_contact','$user_branch','$user_image')";
