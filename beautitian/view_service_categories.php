                    ...
                    <table class="table table-hover table-striped table-bordered"><!-- tabel tabel-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_service_categories = "select * from service_categories";
                                ...
                                while($row_service_categories=mysqli_fetch_array($run_service_categories)){
                                    ...
                                    $service_categories_id = $row_service_categories['service_cat_id'];
                                    
                                    $service_categories_name = $row_service_categories['service_cat_name'];
